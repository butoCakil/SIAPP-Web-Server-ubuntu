            ...
            <div class="post-grad">
                <div class="content-poost">
                    ...
                    <?php } elseif (@$_GET['s'] == 'listrecord') { ?>
                        ...
                        <?php
                        if (@$_SESSION['tampilanriwayat'] || @$_POST['tampilanriwayat']) {
                            if (@$_POST['tampilanriwayat']) {
                                $tampilhari = @$_POST['tampilhaririwayat'];
                                $tampilket = @$_POST['tampilketriwayat'];
                                $tampiljlm = @$_POST['tampiljmlriwayat'];
                                $_SESSION['tampilanriwayat'] = "OK";
                                $_SESSION['tampilhaririwayat'] = $tampilhari;
                                $_SESSION['tampilketriwayat'] = $tampilket;
                                $_SESSION['tampiljmlriwayat'] = $tampiljlm;
                                $_POST['tampilanriwayat'] = "";
                        ...
                        <div class="" style="min-height: 400px;">
                            <div class="box recent shadow_1">
                                ...
                                <div class="ml-2 mt-2">
                                    <!-- <p id="ket1">Ditampilkan 20 catatan terakhir -->
                                    <p id="ket1" style="font-size: 14px; font-weight: 500;">Tampilkan "<?= $ket; ?>", <?= $tampiljlm; ?> data, <?= $kethari; ?>
                                        <a class="mt-1 text-decoration-none badge bg-primary mr-2" style="float: right;">Tampilkan semua</a>
                                    </p>
                                </div>
                ...
                <?php } else { ?>
                    <div class="mt-4 text-center">
                        <?php if ($_GET['s'] == 'listrecord') { ?>
                            <a href="?s=liverecord" class="btn btn-outline-light btn-sm rounded-pill">🔴&nbsp;Live&nbsp;Record</a>
                        <?php } else { ?>
                            <a href="?s=listrecord" class="btn btn-outline-warning btn-sm rounded-pill border-2">🗒️&nbsp;Tampil&nbsp;List&nbsp;Record</a>
                        <?php } ?>
                    </div>
                    <hr>
