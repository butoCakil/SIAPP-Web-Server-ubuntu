             ...
             <?php
                ...
                ?>
                     <tr>
                         <td><?= $ii; ?></td>
                         <td>
                             <a href="rekapbulan.php?kelasjur=<?= preg_replace("/\s+/", "", $value_kodeinfo['info']); ?>&bulan=<?= $tahun_pilih; ?>-<?= duadigit($bulan_pilih); ?>" class="text-decoration-none">
                         ...
                         <?php
                            ...
                            ?>
                                 <td>
                                     <span class="badge bg-dark">D:&nbsp;<?= $persent_loop; ?></span>
                                     <span class="badge bg-success">M:&nbsp;<?= $persent_MSK; ?></span>
                                     <span class="badge bg-warning">T:&nbsp;<?= $persent_TLT; ?></span>
                                     <span class="badge bg-danger">A:&nbsp;<?= $persent_ALP; ?></span>
