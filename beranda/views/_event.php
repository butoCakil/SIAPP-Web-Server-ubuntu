                ...
                <div id="header_rekap" class="card bg-gradient-primary" style="z-index: 1;">
                    <div class="card-body">
                        <div style="display: flex; justify-content: baseline; justify-content: space-between;">
                            <a class="nav-link bg-light bg-gradient-light elevation-2" style="border-radius: 5px;" href="event.php?bulan=<?= $bulan_tahun_pilihmin; ?>&kelasjur=<?= $kelasjur; ?>"><i class="fas fa-angle-double-left"></i>
                ...
                <div class="col-12">
                    <div class="card bg-gradient-primary" style="z-index: 1;">
                        <div class="d-flex justify-content-end m-2">
                            <a target="_blank" href="print_event.php?kelasjur=<?= $kelasjur; ?>&bulan=<?= $bulan_tahun_pilih; ?>&a=print" class="btn btn-dark rounded-0"><i class="fas fa-print"></i>&nbsp;Print</a>
                            <a target="_blank" href="print_event.php?kelasjur=<?= $kelasjur; ?>&bulan=<?= $bulan_tahun_pilih; ?>&a=excel" class="btn btn-success rounded-0"><i class="fas fa-file-excel"></i>&nbsp;Excel</a>
                        </div>
                    </div>
                                    ...
                                    <tr class="perharipertanggal">
                                        ...
                                        ?>
                                                ...
                                                <td id="setketerangan<?= $nis_datasiswa; ?><?= $tanggal_loop; ?>">
                                                    <a type="button" onclick="updateModal('<?= $nis_datasiswa; ?>', '<?= $nama_datasiswa; ?>', '<?= $kelas_datasiswa; ?>', '<?= $tanggal_loop; ?>', '<?= $ket_mulai; ?>', '<?= $ket_selesai; ?>');" class="text-decoration-none" data-bs-toggle="modal" data-bs-target="#editdetail">
                                                        <?= $keterangan; ?>
                                                    </a>
                                                </td>
                                        <?php
