            ...
            <div class="col-12">
                <div id="header_rekap" class="card bg-gradient-primary" style="z-index: 1;">
                    <div class="card-body">
                        <div style="display: flex; justify-content: baseline; justify-content: space-between;">
                            <a class="nav-link bg-light bg-gradient-light elevation-2" style="border-radius: 5px;" href="rekapbulan.php?bulan=<?= $bulan_tahun_pilihmin; ?>&kelasjur=<?= $kelasjur; ?>"><i class="fas fa-angle-double-left"></i>
                                <span>Bulan Sebelumnya</span>
                            </a>
                            <h4 class="mt-2"><b><?= $nama_bulan_indo_pilih . ' </b> ' . $tahun_pilih; ?></h4>
                            <a class="nav-link elevation-2 bg-gradient-light bg-light<?= $disable; ?>" style="border-radius: 5px;" href="<?= $bulan_tahun_pilihplus; ?>&kelasjur=<?= $kelasjur; ?>">
                ...
                <div id="pilihkelasrekapsemua" class="col-12" style="display: block; margin-left: auto; margin-right: auto; margin-top: -20px;">
                    <div class="card">
                        <div class="card-body">
                            <div class="btn-group">
                                <a href="?jur=AT&bulan=<?= $bulan_tahun_pilih; ?>&kelas=" type="button" class="disabled btn btn-success bg-gradient-success">AT</a>
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a class="dropdown-item disabled" href="?jur=AT&kelas=X&bulan=<?= $bulan_tahun_pilih; ?>">Kelas X AT &nbsp;&nbsp;&raquo;</a>
                                        <ul class="submenu dropdown-menu">
                                            <li><a class="dropdown-item" href="?kelasjur=XAT1&bulan=<?= $bulan_tahun_pilih; ?>"> X AT 1 </a></li>
                                            <li><a class="dropdown-item" href="?kelasjur=XAT2&bulan=<?= $bulan_tahun_pilih; ?>"> X AT 2 </a></li>
                                            <li><a class="dropdown-item" href="?kelasjur=XAT3&bulan=<?= $bulan_tahun_pilih; ?>"> X AT 3 </a></li>
                                        </ul>
                                    </li>
                                    <li><a class="dropdown-item disabled" href="?jur=AT&kelas=XI&bulan=<?= $bulan_tahun_pilih; ?>">Kelas XI AT &nbsp;&raquo;</a>
                                        <ul class="submenu dropdown-menu">
                                            <li><a class="dropdown-item" href="?kelasjur=XIAT1&bulan=<?= $bulan_tahun_pilih; ?>"> XI AT 1 </a></li>
                                            <li><a class="dropdown-item" href="?kelasjur=XIAT2&bulan=<?= $bulan_tahun_pilih; ?>"> XI AT 2 </a></li>
                                            <li><a class="dropdown-item" href="?kelasjur=XIAT3&bulan=<?= $bulan_tahun_pilih; ?>"> XI AT 3 </a></li>
                                        </ul>
                                    </li>
                                    <li><a class="dropdown-item disabled" href="?jur=AT&kelas=XII&bulan=<?= $bulan_tahun_pilih; ?>">Kelas XII AT &raquo;</a>
                                        <ul class="submenu dropdown-menu">
                                            <li><a class="dropdown-item" href="?kelasjur=XIIAT1&bulan=<?= $bulan_tahun_pilih; ?>"> XII AT 1 </a></li>
                                            <li><a class="dropdown-item" href="?kelasjur=XIIAT2&bulan=<?= $bulan_tahun_pilih; ?>"> XII AT 2 </a></li>
                                            <li><a class="dropdown-item" href="?kelasjur=XIIAT3&bulan=<?= $bulan_tahun_pilih; ?>"> XII AT 3 </a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                            <div class="btn-group">
                                <a href="?jur=DKV&bulan=<?= $bulan_tahun_pilih; ?>&kelas=" type="button" class="btn btn-primary bg-gradient-primary disabled">DKV</a>
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a class="dropdown-item disabled" href="?jur=DKV&kelas=X&bulan=<?= $bulan_tahun_pilih; ?>">Kelas X DKV&nbsp;&nbsp;&nbsp;&raquo;</a>
                                        <ul class="submenu dropdown-menu">
                                            <li><a class="dropdown-item" href="?kelasjur=XDKV1&bulan=<?= $bulan_tahun_pilih; ?>"> X DKV 1 </a></li>
                                            <li><a class="dropdown-item" href="?kelasjur=XDKV2&bulan=<?= $bulan_tahun_pilih; ?>"> X DKV 2 </a></li>
                                            <li><a class="dropdown-item" href="?kelasjur=XDKV3&bulan=<?= $bulan_tahun_pilih; ?>"> X DKV 3 </a></li>
                                        </ul>
                                    </li>
                                    <li><a class="dropdown-item disabled" href="?jur=DKV&kelas=XI&bulan=<?= $bulan_tahun_pilih; ?>">Kelas XI DKV&nbsp;&nbsp;&raquo;</a>
                                        <ul class="submenu dropdown-menu">
                                            <li><a class="dropdown-item" href="?kelasjur=XIDKV1&bulan=<?= $bulan_tahun_pilih; ?>"> XI DKV 1 </a></li>
                                            <li><a class="dropdown-item" href="?kelasjur=XIDKV2&bulan=<?= $bulan_tahun_pilih; ?>"> XI DKV 2 </a></li>
                                            <li><a class="dropdown-item" href="?kelasjur=XIDKV3&bulan=<?= $bulan_tahun_pilih; ?>"> XI DKV 3 </a></li>
                                        </ul>
                                    </li>
                                    <li><a class="dropdown-item disabled" href="?jur=DKV&kelas=XII&bulan=<?= $bulan_tahun_pilih; ?>">Kelas XII DKV&nbsp;&raquo;</a>
                                        <ul class="submenu dropdown-menu">
                                            <li><a class="dropdown-item" href="?kelasjur=XIIDKV1&bulan=<?= $bulan_tahun_pilih; ?>"> XII DKV 1 </a></li>
                                            <li><a class="dropdown-item" href="?kelasjur=XIIDKV2&bulan=<?= $bulan_tahun_pilih; ?>"> XII DKV 2 </a></li>
                                            <li><a class="dropdown-item" href="?kelasjur=XIIDKV3&bulan=<?= $bulan_tahun_pilih; ?>"> XII DKV 3 </a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                            <div class="btn-group">
                                <a href="?jur=TE&bulan=<?= $bulan_tahun_pilih; ?>&kelas=" type="button" class="btn btn-warning bg-gradient-warning disabled">TE</a>
                                ...
                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <li><a class="dropdown-item disabled" href="?jur=TE&kelas=X&bulan=<?= $bulan_tahun_pilih; ?>">Kelas X TE&nbsp;&nbsp;&nbsp;&raquo;</a>
                                        <ul class="submenu dropdown-menu">
                                            <li><a class="dropdown-item" href="?kelasjur=XTE1&bulan=<?= $bulan_tahun_pilih; ?>"> X TE 1 </a></li>
                                            <li><a class="dropdown-item" href="?kelasjur=XTE2&bulan=<?= $bulan_tahun_pilih; ?>"> X TE 2 </a></li>
                                            <li><a class="dropdown-item" href="?kelasjur=XTE3&bulan=<?= $bulan_tahun_pilih; ?>"> X TE 3 </a></li>
                                        </ul>
                                    </li>
                                    <li><a class="dropdown-item disabled" href="?jur=TE&kelas=XI&bulan=<?= $bulan_tahun_pilih; ?>">Kelas XI TE&nbsp;&nbsp;&raquo;</a>
                                        <ul class="submenu dropdown-menu">
                                            <li><a class="dropdown-item" href="?kelasjur=XITE1&bulan=<?= $bulan_tahun_pilih; ?>"> XI TE 1 </a></li>
                                            <li><a class="dropdown-item" href="?kelasjur=XITE2&bulan=<?= $bulan_tahun_pilih; ?>"> XI TE 2 </a></li>
                                            <li><a class="dropdown-item" href="?kelasjur=XITE3&bulan=<?= $bulan_tahun_pilih; ?>"> XI TE 3 </a></li>
                                        </ul>
                                    </li>
                                    <li><a class="dropdown-item disabled" href="?jur=TE&kelas=XII&bulan=<?= $bulan_tahun_pilih; ?>">Kelas XII TE&nbsp;&raquo; </a>
                                        <ul class="submenu dropdown-menu">
                                            <li><a class="dropdown-item" href="?kelasjur=XIITE1&bulan=<?= $bulan_tahun_pilih; ?>"> XII TE 1 </a></li>
                                            <li><a class="dropdown-item" href="?kelasjur=XIITE2&bulan=<?= $bulan_tahun_pilih; ?>"> XII TE 2 </a></li>
                                            <li><a class="dropdown-item" href="?kelasjur=XIITE3&bulan=<?= $bulan_tahun_pilih; ?>"> XII TE 3 </a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                            <div>
                                <a href="" class="btn btn-dark bg-gradient-dark <?= $elevation3_smw; ?> no-border<?= $bbtn_kls_smw; ?>">
                        ...
                        <?php if (!@$_GET['kelasjur']) { ?>
                            <div id="" class="form-text text-center mb-3 mt-0"><span class="text-danger m-0">*</span>&nbsp;Pilih Kelas dan Bulan untuk ditampilkan.</div>
                        <?php } ?>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card bg-gradient-primary" style="z-index: 1;">
                        <div class="d-flex justify-content-end m-2">
                            <a target="_blank" href="print_rekapbulan.php?kelasjur=<?= $kelasjur; ?>&bulan=<?= $bulan_tahun_pilih; ?>&a=print" class="btn rounded-0 btn-dark"><i class="fas fa-print"></i>&nbsp;Print</a>
                            <a target="_blank" href="print_rekapbulan.php?kelasjur=<?= $kelasjur; ?>&bulan=<?= $bulan_tahun_pilih; ?>&a=excel" class="btn rounded-0 btn-success"><i class="fas fa-file-excel"></i>&nbsp;Excel</a>
                        </div>
                    </div>
                                ...
                                ?>
                                    ...
                                    <tr class="perharipertanggal">
                                        ...
                                        <td class="freez1" style="text-align: left;">
                                            <a href="rekappersiswa.php?n=<?= $datasiswa[$j]['nick']; ?>&bulan=<?= $bulan_ini; ?>" class="text-decoration-none">
                                                <?= $nama_datasiswa; ?>
                                            </a>
                                        </td>
                                        ...
                                        ?>
                                                ...
                                                <td id="setketerangan<?= $nis_datasiswa; ?><?= $tanggal_loop; ?>">
                                                    <a type="button" onclick="updateModal('<?= $nis_datasiswa; ?>', '<?= $nama_datasiswa; ?>', '<?= $kelas_datasiswa; ?>', '<?= $tanggal_loop; ?>', '<?= $keterangan_masuk; ?>', '<?= $keterangan_pulang; ?>');" class="text-decoration-none" data-bs-toggle="modal" data-bs-target="#editdetail">
                                                        <?= $keterangan; ?>
                                                    </a>
                                                </td>
                                        <?php
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="" method="post">
                    ...
                    <div class="mb-2">
                        <label for="modal-keteranganmasuk" class="form-label">Keterangan Masuk&nbsp;<b class="text-danger">*</b></label>
                        <!-- <input type="text" id="modal-keteranganmasuk" class="form-control"> -->
                        <select id="modal-keteranganmasuk" class="form-select" aria-label="Default select example" <?= (($akses_login == "Wali Kelas") || ($akses_login == "admin")) ? "disabled" : ""; ?>>
                    ...
                    <div class="mb-2">
                        <label for="modal-keteranganpulang" class="form-label">Keterangan Pulang&nbsp;<b class="text-danger">*</b></label>
                        <!-- <input type="text" id="modal-keteranganpulang" class="form-control"> -->
                        <select id="modal-keteranganpulang" class="form-select" aria-label="Default select example" <?= (($akses_login == "Wali Kelas") || ($akses_login == "admin")) ? "disabled" : ""; ?>>
